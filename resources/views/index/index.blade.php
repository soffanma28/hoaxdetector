...
<div id="home" style="margin-top: 30px;">
	<div class="container">
		<div class="agileits_w3layouts_heding">
			...
			<p>KKN TEMATIK LINGKAR KAMPUS KELURAHAN ROWOSARI</p>
				...
				<div class="reset">
					<form id="form_classification" action="#" method="post">
						...
						<div class="col-md-12 fields">
							<textarea name="teks" placeholder="Paste berita yang mencurigakan disini (Headline berita, Paragraf, dan yang lainnya)" required="" style="height: 170px!important;"></textarea>
						</div>
